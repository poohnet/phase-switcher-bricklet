...
#define PHASE_SWITCHER_CHANNEL_LED_CONFIG_OFF 0
#define PHASE_SWITCHER_CHANNEL_LED_CONFIG_ON 1
#define PHASE_SWITCHER_CHANNEL_LED_CONFIG_SHOW_HEARTBEAT 2
#define PHASE_SWITCHER_CHANNEL_LED_CONFIG_SHOW_CHANNEL_STATUS 3
